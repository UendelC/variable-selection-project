...
hidden_neurons_1 = [10, 50, 100, 150, 200, 250, 300]
...
for n in hidden_neurons_1:
    ...
    for lr in lrs:
        ...
        result.append([n, lr, r2, mae])
        print(['Sem Log', n, lr, r2, mae])
        ...
        result_log.append([n, lr, r2_log, mae_log])
        print(['Com Log', n, lr, r2_log, mae_log])
